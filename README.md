...
2. **点击右上角 About 左边的绿色的 `Code` 按钮, 再点击 `Download ZIP` 下载亦或者通过链接下载[`https://github.com/FloraBotTeam/FloraBot/archive/refs/heads/main.zip`](https://github.com/FloraBotTeam/FloraBot/archive/main.zip)**  
